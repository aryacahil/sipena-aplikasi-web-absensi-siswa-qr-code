        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h3 class="mb-0 text-white">Edit Kelas</h3>
                </div>
                <div>
                        ...
                        <div class="row">
                                ...
                                <select class="form-select @error('jurusan_id') is-invalid @enderror" 
                                    ...
                                    @foreach($jurusans as $jurusan)
                                        <option value="{{ $jurusan->id }}" 
                                            {{ old('jurusan_id', $kela->jurusan_id) == $jurusan->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tingkat') is-invalid @enderror" 
                                    ...
                                    <option value="10" {{ old('tingkat', $kela->tingkat) == '10' ? 'selected' : '' }}>Kelas 10</option>
                                    <option value="11" {{ old('tingkat', $kela->tingkat) == '11' ? 'selected' : '' }}>Kelas 11</option>
                                    <option value="12" {{ old('tingkat', $kela->tingkat) == '12' ? 'selected' : '' }}>Kelas 12</option>
                                </select>
                                @error('tingkat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="kode_kelas" 
                                       name="kode_kelas" 
                                       value="{{ old('kode_kelas', $kela->kode_kelas) }}" 
                                       required>
                                @error('kode_kelas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
